"""static variable is object independent,
to access the getter setter methods without an object we need static methods.
Static methods can be accessed without an object. They are accessed using the class name.
